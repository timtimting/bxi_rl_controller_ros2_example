...
package_name = 'bxi_example_py_foot'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'bxi_example_py_foot = bxi_example_py_foot.bxi_example:main',
            'bxi_example_py_foot_run = bxi_example_py_foot.bxi_example_run:main',
            'bxi_example_py_foot_walk = bxi_example_py_foot.bxi_example_walk:main',
        ],
    },
)
